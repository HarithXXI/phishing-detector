        ...
        <div id="pgFraudContainer">
            ...
            <div class="pg-disclaimer-card ${riskClass}">
                ...
                <div style="margin-top: 14px;">
                    <a href="https://cybercrime.gov.in" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 8px; background: #DC2626; color: #FFFFFF; font-size: 13px; font-weight: 600; padding: 8px 16px; border-radius: 8px; text-decoration: none; transition: background 0.2s ease;">
                        🚨 Report Fraud to CyberCrime Portal (cybercrime.gov.in)
                    </a>
                </div>
